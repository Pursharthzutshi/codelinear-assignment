...
export default function Header() {
  return (
    <section
      id="hero"
      className="relative min-h-170 pt-28 sm:pt-36 pb-12 flex flex-col"
      ...
      <div className="container mx-auto flex-1 flex items-center">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-10 lg:gap-16 w-full">
          ...
          <div className="flex flex-col gap-5 max-w-[580px] w-full text-center lg:text-left">
            <h2 className="text-[2rem] sm:text-[2.75rem] lg:text-[3.25rem] font-semibold leading-[1.15] tracking-tight text-white">
