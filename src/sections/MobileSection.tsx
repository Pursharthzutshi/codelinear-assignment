  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto max-w-[1200px] relative z-10">
        ...
        {/* Refactored Row-by-Row Layout */}
        <div className="flex flex-col gap-24 md:gap-20">
          
          {/* Row 1 */}
          <div className="grid grid-cols-1 md:grid-cols-[1fr_auto_1fr] gap-y-12 gap-x-12 lg:gap-x-24 items-center">
            <div className="flex flex-col gap-4 md:pt-12 lg:pr-8 items-center md:items-start text-center md:text-left">
            ...
            <div className="flex justify-center w-[280px] lg:w-[320px] mx-auto">
              <img src={phoneHome} alt="Phone Dashboard" className="w-full h-auto drop-shadow-2xl object-contain rounded-[32px]" />
            </div>

            <div className="flex flex-col gap-4 lg:pl-8 w-full max-w-[380px] mx-auto md:mx-0 items-center md:items-start text-center md:text-left">
          ...
          <div className="grid grid-cols-1 md:grid-cols-[1fr_auto_1fr] gap-y-12 gap-x-12 lg:gap-x-24 items-center">
            ...
            <div className="flex flex-col w-full max-w-[380px] mx-auto md:mx-0 items-center md:items-start text-center md:text-left">
            ...
            <div className="flex justify-center w-[280px] lg:w-[320px] mx-auto lg:pr-8 md:justify-self-end">
          ...
          <div className="grid grid-cols-1 md:grid-cols-[1fr_auto_1fr] gap-y-12 gap-x-12 lg:gap-x-24 items-center">
            ...
            <div className="flex flex-col w-full max-w-[380px] mx-auto md:mx-0 items-center md:items-start text-center md:text-left lg:pl-8 md:justify-self-end">
